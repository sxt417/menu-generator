...
`menu-generator` 是一个面向 Codex 的视觉生成 Skill。它会先理解并保留原始菜品与器皿，再根据食品或饮品类型动态选择信息模块、摄影视角与版式系统，最终输出带有可靠中文排版的精致菜单视觉。
...
- **确定性中文排版**：摄影底图不依赖图像模型生成汉字，文字通过 SVG、HTML 或图像合成单独完成。
